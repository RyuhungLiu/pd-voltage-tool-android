...
- Caches matching firmware after the first download and reuses it from the same button
- Flashes only after reconnecting and granting USB permission in Bootloader mode
